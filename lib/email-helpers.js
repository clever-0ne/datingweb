...
// Branded email template with blue buttons and Tesla logo
...
.content { padding: 20px 0; line-height: 1.6; text-align: center; }
.content h1 { font-size: 24px; margin: 0 0 15px 0; text-align: center; }
.content h2 { font-size: 18px; margin: 15px 0 10px 0; text-align: center; }
.content p { margin: 12px auto; text-align: center; }
.content ul { margin: 12px auto; padding-left: 20px; display: inline-block; text-align: left; }
.content li { margin: 6px 0; }
.code-box { padding: 20px; border-radius: 6px; margin: 20px auto; text-align: center; border: 1px solid #ddd; }
...
.footer { padding: 20px 0; text-align: center; color: #888; font-size: 11px; border-top: 1px solid #ddd; }
</style>
</head>
<body>
<div class="container">
...
<p style="margin: 5px 0 0 0;">support@podz.buzz</p>
    ...
    return { success: true, id: result?.id || result?.email };
  } catch (error) {
...
.code-box { padding: 20px; border-radius: 6px; margin: 20px auto; text-align: center; border: 1px solid #ddd; }
.code-display { font-size: 32px; font-weight: bold; letter-spacing: 6px; color: #0066ff; font-family: 'Courier New', monospace; }
.code-label { font-size: 14px; color: #666; margin-top: 8px; }
.button { display: inline-block; padding: 10px 25px; background-color: #0066ff; color: white; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 15px 0; }
.footer { padding: 20px 0; text-align: center; color: #888; font-size: 11px; border-top: 1px solid #ddd; }
</style>
</head>
