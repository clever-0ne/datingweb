...
.content h1 { font-size: 24px; margin: 0 0 15px 0; }
.content h2 { font-size: 18px; margin: 15px 0 10px 0; }
.content p { margin: 12px 0; }
.content ul { margin: 12px 0; padding-left: 20px; }
.content li { margin: 6px 0; }
.code-box { padding: 20px; border-radius: 6px; margin: 20px 0; text-align: center; border: 1px solid #ddd; }
